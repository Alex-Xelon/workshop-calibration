...
for method in ["___", "___"]:  # TODO
    ...
    probs_cal = calibrated_model.predict_proba(___)  # TODO
...
acc_cal = f1_score(___, ___, average="___")  # TODO
...
probs_va = va.predict_proba(___)  # TODO
preds_va = va.predict(___, one_hot=___)  # TODO
